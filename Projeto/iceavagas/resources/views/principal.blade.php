...
<head>
    ...
    <script src="{{asset('/js/verificadados.js')}}"></script>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-info">
        <a class="navbar-brand" href="{{route('inicial')}}"> <i class="fas fa-user-tie"></i> <b>ICEA</b> Vagas</a>
             ...
             <ul class="navbar-nav ml-auto">
                ...
                @else
                    <li class="nav-item dropdown">
                        <a id="navbarDropdown" class="nav-link dropdown-toggle bg-light text-dark" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                          Olá, {{ Auth::user()->name }}
                        </a>
